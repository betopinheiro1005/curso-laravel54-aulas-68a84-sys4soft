...
class usuariosController extends Controller
{
    ...
    public function executarRecuperarSenha(Request $request){
        ...
        /*
            1 - Ter usuário com email válido.
            2 - Verificar se o email inserido corresponde ao do usuário
            3 - Sistema cria senha aleatória
            3a - Registrar (alterar) a senha do usuário na base de dados
            4 - Envia email com a nova senha para o email do usuário
            5 - Informa (view) o usuário que foi enviada senha para o email dele.
